...
public class CarControllerTest {
    ...
    public void listCars() throws Exception {
        ...
        mvc.perform(
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.content[*].location.lat").value(40.730610))
                .andExpect(MockMvcResultMatchers.jsonPath("$.content[*].location.lon").value(-73.935242))
                .andExpect(MockMvcResultMatchers.jsonPath("$.content[*].details.manufacturer.code").value(101))
                .andExpect(MockMvcResultMatchers.jsonPath("$.content[*].details.manufacturer.name").value("Chevrolet"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.content[*].details.model").value("Impala"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.content[*].details.body").value("sedan"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.content[*].details.mileage").value(32280))
                .andExpect(MockMvcResultMatchers.jsonPath("$.content[*].details.externalColor").value("white"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.content[*].details.engine").value("3.6L V6"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.content[*].details.fuelType").value("Gasoline"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.content[*].details.modelYear").value(2018))
                .andExpect(MockMvcResultMatchers.jsonPath("$.content[*].details.productionYear").value(2018))
                .andExpect(MockMvcResultMatchers.jsonPath("$.content[*].details.numberOfDoors").value(4))
                .andExpect(MockMvcResultMatchers.jsonPath("$.content[*].condition").value("USED")
                );
    }
